...
def get_tokens(model_or_processor, prompt):
    ...
    """
    if isinstance(model_or_processor, HookedVLTransformer):
        return [
...
def get_hook_dim(model, hook_name):
    ...
    """
    return {
        utils.get_act_name("hook_embed", 0): model.cfg.d_model,
        utils.get_act_name("v_input", 0): model.cfg.d_model,
        utils.get_act_name("k_input", 0): model.cfg.d_model,
        utils.get_act_name("q_input", 0): model.cfg.d_model,
        utils.get_act_name("z", 0): model.cfg.d_head,
        utils.get_act_name("result", 0): model.cfg.d_model,
        utils.get_act_name("attn_out", 0): model.cfg.d_model,
        utils.get_act_name("mlp_post", 0): model.cfg.d_mlp,
        utils.get_act_name("mlp_in", 0): model.cfg.d_model,
        utils.get_act_name("mlp_out", 0): model.cfg.d_model,
        utils.get_act_name("resid_pre", 0): model.cfg.d_model,
        utils.get_act_name("resid_post", 0): model.cfg.d_model,
    }[utils.get_act_name(hook_name, 0)]
